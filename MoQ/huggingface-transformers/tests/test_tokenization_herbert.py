...
class HerbertTokenizationTest(TokenizerTesterMixin, unittest.TestCase):
    ...
    def test_full_tokenizer(self):
        tokenizer = self.tokenizer_class(vocab_file=self.vocab_file,
    ...
    def test_sequence_builders(self):
        ...
        text = tokenizer.encode("konstruowanie sekwencji",
                                add_special_tokens=False)
        text_2 = tokenizer.encode("konstruowanie wielu sekwencji",
                                  add_special_tokens=False)
