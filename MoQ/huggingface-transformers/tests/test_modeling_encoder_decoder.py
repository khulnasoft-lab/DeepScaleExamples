...
class EncoderDecoderMixin:
    ...
    def check_encoder_decoder_model_output_attentions(
        ...
        self.assertEqual(
            ...
            (config.num_attention_heads, input_ids.shape[-1],
             input_ids.shape[-1]),
        )
...
class BertEncoderDecoderModelTest(EncoderDecoderMixin, unittest.TestCase):
    ...
    def test_bert2bert_summarization(self):
        ...
        self.assertEqual(summary,
                         [EXPECTED_SUMMARY_SIGMA, EXPECTED_SUMMARY_AMERICA])


@require_torch
class BertGenerationEncoderDecoderModelTest(EncoderDecoderMixin,
                                            unittest.TestCase):
    def get_pretrained_model(self):
        return EncoderDecoderModel.from_encoder_decoder_pretrained(
    ...
    def test_roberta2roberta_summarization(self):
        ...
        self.assertEqual(summary,
                         [EXPECTED_SUMMARY_PS3, EXPECTED_SUMMARY_TOSHIBA])
...
@require_torch
class ProphetNetEncoderDecoderModelTest(EncoderDecoderMixin,
                                        unittest.TestCase):
    def get_encoder_decoder_model(self, config, decoder_config):
        encoder_model = BertModel(config)
