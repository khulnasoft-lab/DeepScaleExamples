...
class ZeroShotClassificationPipelineTests(CustomInputPipelineCommonMixin,
                                          unittest.TestCase):
    ...
    def _test_pipeline(self, nlp: Pipeline):
        ...
        self.assertEqual(len(multi_result),
                         len(valid_multi_input["sequences"]))
            ...
            inputs = [
                {
                    "sequences": "Who are you voting for in 2020?",
                    "candidate_labels":
                    ["politics", "public health", "science"],
                },
                {
                    "sequences":
                ...
                for key in output:
                    if key == "scores":
                        for output_score, expected_score in zip(
                            ...
                            self.assertAlmostEqual(output_score,
                                                   expected_score,
                                                   places=2)
                    else:
