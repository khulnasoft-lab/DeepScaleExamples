...
extras["tf-cpu"] = deps_list("tensorflow-cpu", "onnxconverter-common",
                             "keras2onnx")
...
if os.name == "nt":  # windows
    extras["retrieval"] = deps_list(
        "datasets")  # faiss is not supported on windows
...
extras["testing"] = (deps_list(
    ...
    "psutil",
    "datasets",
) + extras["retrieval"] + extras["modelcreation"] + extras["speech"])
...
extras["all"] = (extras["tf"] + extras["torch"] + extras["flax"] +
                 extras["sentencepiece"] + extras["tokenizers"])

extras["dev"] = (extras["all"] + extras["testing"] + extras["quality"] +
                 extras["ja"] + extras["docs"] + extras["sklearn"] +
...
setup(
    name="transformers",
    version=
    "4.4.0.dev0",  # expected format is one of x.y.z.dev0, or x.y.z.rc1 or x.y.z (no to dashes, yes to dots)
    author=
    "Thomas Wolf, Lysandre Debut, Victor Sanh, Julien Chaumond, Sam Shleifer, Patrick von Platen, Sylvain Gugger, Google AI Language Team Authors, Open AI team Authors, Facebook AI Authors, Carnegie Mellon University Authors",
