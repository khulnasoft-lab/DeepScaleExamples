...
or you can download the original data from (https://download.khulnasoft.com/download/D/4/6/D46FF87A-F6B9-4252-AA8B-3604ED519838/MSRParaphraseCorpus.msi) and extract the data from it manually.
...
def format_mrpc(data_dir, path_to_data):
    ...
    assert os.path.isfile(mrpc_train_file), ("Train data not found at %s" %
                                             mrpc_train_file)
