...
class Trainer:
    ...
    def __init__(
        ...
        if self.is_model_parallel or (args.deepscale and args.do_train) or (args.fp16_full_eval and not args.do_train):
    ...
    def train(
        ...
        **kwargs,
        ...
        if self.args.deepscale:
            model, optimizer, lr_scheduler = init_deepscale(self, num_training_steps=max_steps)
        ...
        for epoch in range(epochs_trained, num_train_epochs):
            ...
            for step, inputs in enumerate(epoch_iterator):
                ...
                if (step + 1) % self.args.gradient_accumulation_steps == 0 or (
                    ...
                    # Gradient clipping
                    if self.args.max_grad_norm is not None and self.args.max_grad_norm > 0 and not self.deepscale:
    ...
    def _load_optimizer_and_scheduler(self, checkpoint):
        ...
        if self.deepscale:
            ...
            self.deepscale.load_checkpoint(checkpoint, load_optimizer_states=True, load_lr_scheduler_states=True)
    ...
    def prediction_loop(
        ...
        if self.args.deepscale and not self.args.do_train:
            ...
            logger.info("Detected the deepscale argument but it will not be used for evaluation")
