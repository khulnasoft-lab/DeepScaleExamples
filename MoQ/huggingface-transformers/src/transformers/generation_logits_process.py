...
class NoBadWordsLogitsProcessor(LogitsProcessor):
    ...
    def _calc_banned_bad_words_ids(
            self, prev_input_ids: Iterable[int]) -> Iterable[int]:
        banned_tokens = []
    ...
    def _set_scores_to_inf_for_banned_tokens(
        ...
        banned_mask = (torch.sparse.LongTensor(
    ...
    def __call__(
        ...
        for batch_idx in range(batch_size):
            ...
            previous_group_tokens = current_tokens[batch_idx *
                                                   ...
                                                   self._num_beams +
                                                   group_start_idx]
            token_frequency = torch.bincount(previous_group_tokens,
                                             minlength=vocab_size).to(
                                                 scores.device)
