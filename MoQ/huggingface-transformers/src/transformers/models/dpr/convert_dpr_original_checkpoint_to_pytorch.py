...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        type=str,
        help=
        "Type of the component to convert: 'ctx_encoder', 'question_encoder' or 'reader'.",
    )
    parser.add_argument(
        "--src",
        type=str,
        help=
        "Path to the dpr checkpoint file. They can be downloaded from the official DPR repo https://github.com/facebookresearch/DPR. Note that in the official repo, both encoders are stored in the 'retriever' checkpoints.",
    )
    parser.add_argument(
        "--dest",
        type=str,
