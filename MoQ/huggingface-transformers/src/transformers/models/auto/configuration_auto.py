...
ALL_PRETRAINED_CONFIG_ARCHIVE_MAP = dict((key, value) for pretrained_map in [
...
def replace_list_option_in_docstrings(config_to_class=None,
    ...
    def docstring_decorator(fn):
        ...
        if i < len(lines):
            ...
            if use_model_types:
                indent = f"{indent}    "
            lines[i] = _list_model_options(indent,
...
class AutoConfig:
    ...
    def from_pretrained(cls, pretrained_model_name_or_path, **kwargs):
        ...
        raise ValueError(
            ...
            "in its name: {}".format(pretrained_model_name_or_path,
