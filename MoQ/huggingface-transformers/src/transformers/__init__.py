...
_import_structure = {
    ...
    "models.led":
    ["LED_PRETRAINED_CONFIG_ARCHIVE_MAP", "LEDConfig", "LEDTokenizer"],
    "models.longformer": [
    ...
    "models.xlm":
    ["XLM_PRETRAINED_CONFIG_ARCHIVE_MAP", "XLMConfig", "XLMTokenizer"],
...
if is_sentencepiece_available():
    ...
    _import_structure["utils.dummy_sentencepiece_objects"] = [
        name for name in dir(dummy_sentencepiece_objects)
...
if is_tokenizers_available():
    ...
    _import_structure["utils.dummy_tokenizers_objects"] = [
        name for name in dir(dummy_tokenizers_objects)
        if not name.startswith("_")
    ]
