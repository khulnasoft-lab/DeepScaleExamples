...
class GenerationMixin:
    ...
    def _prepare_input_ids_for_generation(
            self, bos_token_id: int) -> torch.LongTensor:
    ...
    def _get_logits_processor(
        ...
        diversity_penalty = (diversity_penalty if diversity_penalty is not None
    ...
    def generate(
        ...
        **model_kwargs,
        ...
        return_dict_in_generate = (return_dict_in_generate
                                   if return_dict_in_generate is not None else
        ...
        is_greedy_gen_mode = ((num_beams == 1) and (num_beam_groups == 1)
        ...
        **model_kwargs,
        ...
        while cur_len < max_length:
            ...
            for beam_group_idx in range(num_beam_groups):
                ...
                if output_scores:
                    processed_score = torch.zeros_like(outputs.logits[:,
                                                                      -1, :])
