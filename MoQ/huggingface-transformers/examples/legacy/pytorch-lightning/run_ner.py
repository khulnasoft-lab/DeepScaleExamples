...
class NERTransformer(BaseTransformer):
    ...
    def training_step(self, batch, batch_num):
        ...
        if self.config.model_type != "distilbert":
            inputs["token_type_ids"] = (
                batch[2] if self.config.model_type in ["bert", "xlnet"] else
                None)  # XLM and RoBERTa don"t use token_type_ids
        ...
        for mode in ["train", "dev", "test"]:
            ...
            if os.path.exists(
                ...
                features = self.token_classification_task.convert_examples_to_features(
                    ...
                    cls_token_segment_id=(2 if self.config.model_type
                                          in ["xlnet"] else 0),
    ...
    def get_dataloader(self,
        ...
        if features[0].token_type_ids is not None:
            ...
            all_token_type_ids = torch.tensor([0 for f in features],
                                              dtype=torch.long)
