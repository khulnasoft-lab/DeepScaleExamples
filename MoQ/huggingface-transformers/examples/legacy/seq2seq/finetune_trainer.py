...
class DataTrainingArguments:
    ...
    task: Optional[str] = field(
        ...
        metadata={
            "help":
            "Task name, summarization (or summarization_{dataset} for pegasus) or translation"
        },
    )
    ...
    ignore_pad_token_for_loss: bool = field(
        ...
        metadata={
            "help":
            "If only pad tokens should be ignored. This assumes that `config.pad_token_id` is defined."
        },
    )
