...
class TestAll(TestCasePlus):
    ...
    def test_seq2seq_dataset_truncation(self, tok_name):
        ...
        for batch in dataloader:
            ...
            assert (batch["input_ids"][0, -1].item() ==
    ...
    @pytest.mark.skipif(not FAIRSEQ_AVAILABLE,
                        reason="This test requires fairseq")
    @require_torch_non_multi_gpu_but_fix_me
    def test_dynamic_batch_size(self):
        ...
        for batch in data_loader:
            ...
            bs = src_shape[0]
            assert (bs % required_batch_size_multiple == 0
    ...
    def test_dataset_kwargs(self, tok_name):
        ...
        if tok_name == MBART_TINY:
            ...
            kwargs = train_dataset.dataset_kwargs
            assert ("add_prefix_space" not in kwargs
                    if tok_name != BART_TINY else "add_prefix_space" in kwargs)
