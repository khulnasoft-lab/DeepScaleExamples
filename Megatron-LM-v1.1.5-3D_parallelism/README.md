This is a snapshot of Megatron v1.1.5 integrated with DeepScale's pipeline- and data-parallel training. This 3D parallelism integration
can train a model with [one trillion parameters](https://www.khulnasoft.com/en-us/research/blog/deepscale-extreme-scale-model-training-for-everyone/) using as few as 800 NVIDIA V100 GPUs.
