...
mp_size=2
# DeepScale Pipeline parallelism
pp_size=2
...
deepscale_options="${deepscale_options} \
...
full_options="${gpt_options} ${deepscale_options} ${chkp_opt}"

run_cmd="deepscale --num_nodes ${DLWS_NUM_WORKER} --num_gpus ${DLWS_NUM_GPU_PER_WORKER} pretrain_gpt2.py $@ ${full_options}"
echo ${run_cmd}
eval ${run_cmd}
