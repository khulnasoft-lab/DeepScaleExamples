...
if args.model_parallel_size > 1:
    multinode_args += " -m torch.distributed.launch --nproc_per_node {} ".format(
...
CMD = " --model-parallel-size {model_par} \
    ...
    model_par=args.model_parallel_size,
...
if args.cloze_eval:
    ...
    CMD += "--train-iters 0 --eval-iters {} --test-data {} --loose-json ".format(
        args.eval_iters, args.data_path)
