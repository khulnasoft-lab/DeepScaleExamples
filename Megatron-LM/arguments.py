...
def add_fp16_config_args(parser):
    ...
    group.add_argument("--fp32-embedding",
                       action="store_true",
                       help="embedding in fp32")
    group.add_argument("--fp32-layernorm",
                       action="store_true",
                       help="layer norm in fp32")
    group.add_argument("--fp32-tokentypes",
                       action="store_true",
...
def add_training_args(parser):
    ...
    group.add_argument(
        ...
        action="store_true",
        help="uses activation checkpointing from deepscale",
    )
...
def add_data_args(parser):
    ...
    group.add_argument("--lazy-loader",
                       action="store_true",
