...
NCCL_TREE_THRESHOLD=0 NCCL_IB_DISABLE=1 NCCL_SOCKET_IFNAME=eth0 deepscale ${base_dir}/../../deepscale_train.py \
...
--job_name $JOB_NAME \
--deepscale_config ${base_dir}/deepscale_bsz32k_onebitlamb_config_seq512_nccl.json \
