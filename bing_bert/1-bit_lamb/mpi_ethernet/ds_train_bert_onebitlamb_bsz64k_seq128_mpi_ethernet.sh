...
NCCL_TREE_THRESHOLD=0 NCCL_IB_DISABLE=1 NCCL_SOCKET_IFNAME=eth0 deepscale --launcher=openmpi ${base_dir}/../../deepscale_train.py \
...
--lr_offset 10e-4 \
--job_name $JOB_NAME \
--deepscale_config ${base_dir}/deepscale_bsz64k_onebitlamb_config_seq128_mpi_ethernet.json \
