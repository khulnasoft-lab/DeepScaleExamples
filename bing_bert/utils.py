...
def get_argument_parser():
    ...
    parser.add_argument(
        ...
        action="store_true",
        help=
        "Use DeepScale transformer kernel memory optimization to checkpoint dropout output.",
    )
    parser.add_argument(
        ...
        action="store_true",
        help=
        "Use DeepScale transformer kernel memory optimization to perform invertible normalize backpropagation.",
    )
    parser.add_argument(
        "--gelu_checkpoint",
        default=False,
        action="store_true",
        help=
        "Use DeepScale transformer kernel memory optimization to checkpoint GELU activation.",
    )
    parser.add_argument(
...
def is_time_to_exit(args, epoch_steps=0, global_steps=0):
    return (epoch_steps >= args.max_steps_per_epoch) or (global_steps >=
                                                         args.max_steps)
