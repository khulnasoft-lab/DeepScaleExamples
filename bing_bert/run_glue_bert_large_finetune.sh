...
run_cmd="python3.6 -m torch.distributed.launch \
       ...
       --fp16 \
       --preln \
       --deepscale_config ${base_dir}/glue_bert_large.json \
       --do_lower_case \
       ...
       --model_file $CHECKPOINT_PATH &> $LOG_DIR/${model_name}/${JOBNAME}_${TASK}_bzs${EFFECTIVE_BATCH_SIZE}_lr${LR}_epoch${NUM_EPOCH}_${NGPU}_deepscale-kernel.txt
       "
echo ${run_cmd}
eval ${run_cmd}
