...
full_options="${gpt_options} ${deepscale_options} ${chkp_opt} ${tile_opt}"

run_cmd="deepscale --num_nodes ${NUM_WORKERS} --num_gpus ${NUM_GPUS_PER_WORKER}  pretrain_gpt2.py ${@:2} ${full_options}"
echo ${run_cmd}
eval ${run_cmd}
