...
class Embedding(MegatronModule):
    ...
    def __init__(
        ...
        if self.num_tokentypes > 0:
            ...
            with deepscale.zero.GatheredParameters(
    ...
    def forward(self, input_ids, position_ids, tokentype_ids=None):
        ...
        if tokentype_ids is not None:
            ...
            embeddings = embeddings + scatter(
                self.tokentype_embeddings(tokentype_ids))
        else:
    ...
    def state_dict_for_save_checkpoint(self,
        ...
        state_dict_[self._position_embeddings_key] = (
            self.position_embeddings.state_dict(destination, prefix,
                                                keep_vars))
        if self.num_tokentypes > 0:
            state_dict_[self._tokentype_embeddings_key] = (
                self.tokentype_embeddings.state_dict(destination, prefix,
                                                     keep_vars))
...
class TransformerLanguageModel(MegatronModule):
    ...
    def state_dict_for_save_checkpoint(self,
        ...
        if self.add_pooler:
            state_dict_[
                self._pooler_key] = self.pooler.state_dict_for_save_checkpoint(
                    destination, prefix, keep_vars)
