...
def training_log(
    ...
    # Tensorboard values.
    if writer and (iteration % args.tensorboard_log_interval
                   == 0) and is_last_rank():
    ...
    with torch.no_grad():
        ...
        while iteration < args.eval_iters:
            ...
            args.consumed_valid_samples += (
                mpu.get_data_parallel_world_size() * args.micro_batch_size *
                get_num_microbatches())
...
def build_train_valid_test_data_iterators(
    ...
    if mpu.get_tensor_model_parallel_rank() == 0:
        ...
        eval_iters = (args.train_iters // args.eval_interval +
                      1) * args.eval_iters
    ...
    if test_dataloader is not None:
        test_data_iterator = (iter(test_dataloader) if dl_type == "single" else
                              iter(cyclic_iter(test_dataloader)))
    else:
